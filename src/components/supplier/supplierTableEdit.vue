              ...
              <el-col :span="16">
                <el-form ref="form" :model="supplierList" label-width="120px">
                  ...
                  <el-form-item label="供应商账号">
                    <el-input v-model="supplierList.supplierId"></el-input>
                  </el-form-item>
                  <!-- <el-form-item label="供应商密码">
                    <el-input v-model="supplierList.password"></el-input>
                  </el-form-item> -->
                  <el-form-item label="供应商手机号">
                    <el-input v-model="supplierList.supplierPhone"></el-input>
                  </el-form-item>
          ...
          <el-tab-pane label="客户评价管理" name="second">
            <div class="mt_table">
              <el-table :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="date" label="评价日期"></el-table-column>
                ...
                <div class="gray_input">
                  <el-form ref="form" :model="supplierList" label-width="120px">
                    <el-form-item label="分销员提成" class="noMargin">
                      <el-input v-model="supplierList.name">
                        <template slot="append">%</template>
                      </el-input>
                    </el-form-item>

                    <el-form-item class="noMargin TIPS">交易担保金额的一定比例作为提成佣金</el-form-item>
                  </el-form>
                </div>
                <div class="gray_input">
                  <el-form ref="form" :model="supplierList" label-width="120px">
          ...
          <el-tab-pane label="服务区域" name="fourth">
            <el-row :gutter="20">
              <el-col :span="16">
                <div
                  class="gray_input"
                  style="background-color:inherit;border: 1px solid rgba(187, 187, 187, 100);"
                >
                  <el-form ref="form" :model="supplierList" label-width="120px">
